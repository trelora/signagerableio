...
RSpec.describe 'When an admin clicks create slide' do
  ...
  it 'the admin is taken to the slide creation form and enters title and subtitle' do
    VCR.use_cassette 'admin_creates_large_subtitle_slide' do
      ...
      expect(Slide.last.role).to eq('confirm-lg-sub-text')
    end
  end
end
